package tuttifrutti.risk.home

import tuttifrutti.data.Address
...
data class House(val category: HouseType) : Building()
...
data class Flat(val category: FlatType, val moreThanFourFloors: Boolean, val moreThanTenFlats: Boolean) : Building()

data class Other() : Building()
